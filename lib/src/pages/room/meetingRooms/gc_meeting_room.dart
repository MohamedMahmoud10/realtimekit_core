...
class RtkGCMeetingRoom extends ConsumerWidget {
  const RtkGCMeetingRoom({super.key,this.customAppBarWidget});
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return WillPopScope(
      ...
      child: Scaffold(
        appBar: RtkAppBars.gc(
          customWidget: customAppBarWidget,

        ),
        body: SafeArea(
          child: ref.watch(tabNotifierProvider).isEmpty ||
                  rtkMeeting.meta.meetingType == RtkMeetingType.livestream
              ?  ActiveParticipantsWidget(customAppBarWidget: customAppBarWidget,)
